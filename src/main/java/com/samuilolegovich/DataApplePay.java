...
@NoArgsConstructor
@AllArgsConstructor
public class DataApplePay {
    private String version;
    private String data;
    private String signature;
    /* note
     * The map "header" must include mandatory keys with a value - the rest are optional:
     *  - ephemeralPublicKey
     *  - transactionId
     * */
